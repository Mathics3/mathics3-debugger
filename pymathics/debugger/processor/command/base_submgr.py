...
from pymathics.debugger.processor.subcmd import Subcmd
...
class SubcommandMgr(DebuggerCommand):
    ...
    def __init__(self, proc, name=None, base="pymathics.debugger"):
    ...
    def _load_debugger_subcommands(self, name, base="pymathics.debugger"):
