...
from pymathics.trepan.processor.subcmd import Subcmd
...
class SubcommandMgr(DebuggerCommand):
    ...
    def __init__(self, proc, name=None, base="pymathics.trepan"):
    ...
    def _load_debugger_subcommands(self, name, base="pymathics.trepan"):
